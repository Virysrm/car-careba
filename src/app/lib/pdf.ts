...
const generatePDF = (
  ...
  const tableBody = [
    ...
    ...products.map((product) => [
      ...
      {
        text: `$ ${product.importe.toFixed(2)}`,
        alignment: "rigth",
      },
    ]),
  ];
  ...
  const subtotal = products.reduce((sum, p) => sum + p.importe, 0);

  const iva = subtotal * 0.16;

  const totalGeneral = subtotal + iva;

  /*Si quieres evitar errores de decimales */
...
content.push({
  ...
  columns: [
    ...
    // 🟦 DERECHA: EMPRESA
    {
      ...
      table: {
        ...
        body: [
          [
            {
              text: [
                { text: "MTRO. ", bold: true, alignment: "right" },
          ...
          [
            {
              text: [
                { text: "TEL: ", bold: true, alignment: "right" },
                "55 1234 5678"
              ],
              margin: [8, 0, 8, 6],
            }
          ...
          [
            {
              text: [
                { text: "EMAIL: ", bold: true, alignment: "right" },
                "contacto@careba.com"
              ],
              margin: [8, 0, 8, 6],
            }
      ...
      layout: {
        hLineWidth: () => 0,
        vLineWidth: () => 0,
        fillColor: () => '#e3f2fd' // 🔥 color diferente para distinguir
      }
    }
  ...
  content.push({
    ...
    columns: [
      ...
      {
        width: 235, // 👈 ancho del cuadro
        table: {
          widths: ["*", "auto"],
          body: [
            [
              { text: "SUBTOTAL CARPINTERÍA:", bold: true, alignment: "right" },
    ...
    columns: [
      // 📄 TERMINOS (lado izquierdo)
      {
        ...
        stack: [
          ...
          {
            text: "SI REQUIERE FACTURA SERA MAS .16%",
            fontSize: 9,
          },
        ],
      },
    ...
    columns: [
      // 📄 TERMINOS (lado izquierdo)
      {
        ...
        stack: [
          ...
          {
            text:
              "• Los trabajos realizados no incluyen materiales adicionales.\n" +
    ...
    return {
      ...
      stack: [
        ...
        },
        {
          ...
          columns: [
            {
              text: "Facebook: @carpinteriacareba | Instagram: @careba.oficial",
              fontSize: 10,
            },
            {
